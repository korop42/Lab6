...
using namespace std;
enum { Exit, ConstructorFlower, ConstructorTree, ConstructorCountryTree, ConstructorFlowerWithThorns, CreateArray, PrintArray, NumberObj, SortArray, ToString, FromString, slen = 10, w = 10 };// констант≥ значенн€ 
...
void printInstances(Base**, int);
void sortByIGetNumber(Base**&, int);
void ArrayPrint(Base**&, int &);
void Array(Base**&, int&);
void ClearArray(Base**&, int&);
